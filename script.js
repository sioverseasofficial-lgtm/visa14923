document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateAndDisplay(data) {
        // Create a payload explicitly for the URL that only uses the tiny photo
        const urlData = { ...data };
    ...
    function populateVisaCard(data) {
        // Use HD if available, otherwise fallback to the tiny QR photo
        const photoSrc = data.photoHD || data.photoQR;
        if (photoSrc) {
            document.getElementById('out-photo').src = photoSrc;
        }
